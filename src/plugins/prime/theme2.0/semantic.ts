  ...
  colorScheme: {
    light: {
      ...
      highlight: {
        ...
        color: '{colors.extend.white.100}',
        focusColor: '{colors.extend.white.100}',
      },
      focusRing: {
      ...
      mask: {
        background: '{colors.extend.black.40}',
        color: '{surface.200}',
      },
      formField: {
        background: '{colors.extend.white.100}',
        disabledBackground: '{colors.zinc.200}',
        readonlyBackground: '{colors.zinc.100}',
        filledBackground: '{colors.extend.white.100}',
        filledHoverBackground: '{colors.extend.white.100}',
        filledFocusBackground: '{colors.extend.white.100}',
        ...
        backgroundHandler: '{colors.extend.white.100}',
      },
      text: {
        color: '{colors.zinc.900}',
        extend: {
          colorPrimaryStatic: '{colors.zinc.900}',
          colorSecondaryStatic: '{colors.extend.white.100}',
          colorInverted: '{colors.extend.white.100}',
        },
      ...
      navigation: {
        ...
        submenuIcon: {
          ...
          activeColor: '{colors.extend.white.100}',
        },
        item: {
          focusBackground: '{colors.zinc.100}',
    ...
    dark: {
      ...
      mask: {
        background: '{colors.extend.black.60}',
        color: '{surface.800}',
      },
      formField: {
        ...
        floatLabelActiveColor: '{colors.zinc.500}',
        floatLabelInvalidColor: '{formField.invalidPlaceholderColor}',
        iconColor: '{colors.extend.white.100}',
