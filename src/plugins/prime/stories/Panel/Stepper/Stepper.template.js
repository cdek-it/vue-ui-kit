      ...
      <Stepper value="1">
        ...
        <StepItem value="2">
          ...
          <StepPanel v-slot="{ activateCallback }">
            ...
            <div class="flex py-6 gap-2">
              <Button label="Back" severity="outlined" @click="activateCallback('1')" />
        ...
        <StepItem value="3">
          ...
          <StepPanel v-slot="{ activateCallback }">
            ...
            <div class="py-6">
              <Button label="Back" severity="outlined" @click="activateCallback('2')" />
            </div>
          </StepPanel>
        </StepItem>
      </Stepper>
          ...
          <Step v-slot="{ activateCallback, value, a11yAttrs }" asChild :value="1">
            <div class="flex flex-row flex-auto gap-2" v-bind="a11yAttrs.root">
              <button class="bg-transparent border-0 inline-flex flex-col gap-2" style="display: flex; flex-direction: row;" @click="activateCallback" v-bind="a11yAttrs.header">
                <span :class="['rounded-full border-2 inline-flex items-center justify-center', { 'bg-primary text-primary-contrast border-primary': value <= activeStep, 'border-surface-200 dark:border-surface-700': value > activeStep }]" 
                      style="width: 32px !important; height: 32px !important; min-width: 32px; min-height: 32px; flex-shrink: 0"
