...
- [**CdekTextarea**](/story/ui-kit-cdektextarea--resize-auto-with-initial-value) теперь CdekTextarea c resize="auto" расчитывает высоту с изначальным value [#104](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/104)
- [**CdekTextarea**](/story/ui-kit-cdektextarea--resize-auto-with-remove-text-button) теперь CdekTextarea c resize="auto" расчитывает высоту при изменении value мимо события input [#104](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/104)
