...
- [**CdekInput**](/story/ui-kit-cdekinput-slots--left-icon-rtl) добавлена поддержка `direction: rtl` в CdekInput [#121](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/121)
- [**CdekTextarea**](/story/ui-kit-cdektextarea--tip-icon-rtl) добавлена поддержка `direction: rtl` в CdekTextarea [#121](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/121)
