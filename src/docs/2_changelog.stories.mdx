...
[`0.6.0`](#0.6.0) [`0.5.0`](#0.5.0) [`0.4.1`](#0.4.1) [`0.4.0`](#0.4.0) [`0.3.0`](#0.3.0) [`0.2.0`](#0.2.0) [`0.1.0-rc-010923`](#0.1.0-rc-010923) [`0.1.0-rc-270723`](#0.1.0-rc-270723) [`0.0.1`](#0.0.1)

## <a name="0.6.0"></a>[0.6.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.6.0)
...
- [**CdekMaskedInput**](/story/ui-kit-cdekmaskedinput--phone) clearable теперь вызывает событие очистки инпута [#101](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/101)
- [**toastification**](/story/plugins-toastification--select-position) выбор позиции теперь работают корректно на мобильных устройствах [#100](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/100)
...
- [**CdekInput**](/story/ui-kit-cdekinput-basic--show-error-if-exist) добавлен параметр `showErrorIfExist` [#103](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/103)
- [**CdekSelect**](/story/ui-kit-cdekselect--show-error-if-exist) добавлен параметр `showErrorIfExist` [#103](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/103)
- [**CdekTextarea**](/story/ui-kit-cdektextarea--show-error-if-exist) добавлен параметр `showErrorIfExist` [#103](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/103)
