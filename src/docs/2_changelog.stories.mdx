...
- [**CdekAlert**](/story/ui-kit-cdekalert--primary-icon-top) добавлена возможность определить положение иконки, если заголовок занимает несколько строк [#99](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/99)
