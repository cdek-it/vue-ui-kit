...
- [**CdekFormControl**](/story/form-cdekformcontrol--change-with-deferred-validation) добавлена возможность отключить валидацию при первом вводе через пропс deferredValidation [#112](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/112)
