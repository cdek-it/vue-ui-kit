...
[`2.0.0`](#2.0.0) [`1.0.0`](#1.0.0) [`0.5.0`](#0.5.0) [`0.4.1`](#0.4.1) [`0.4.0`](#0.4.0) [`0.3.0`](#0.3.0) [`0.2.0`](#0.2.0)
[`0.1.0-rc-010923`](#0.1.0-rc-010923) [`0.1.0-rc-270723`](#0.1.0-rc-270723) [`0.0.1`](#0.0.1)

## <a name="2.0.0" />[2.0.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/2.0.0)

### Changed

* [**useServiceFactory**](/story/services-servicefactory--this) самостоятельно биндит контекст для методов [#25](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/25)
* Обновлен @primevue/auto-import-resolver, @primevue/themes, primevue до 4.3.6, tailwindcss-primeui 0.6.1 [#132](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/132)
* Создание пресета при помощи пакета primeuix [#135](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/135)
* [**Chip**](/story/prime-chip--default-story) исправлены стили для Chip в соответствии с макетами. [#136](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/136)
* [**Accordion**](/docs/prime-accordion--аккордеонс-1-йпанелью) исправлены стили для Accordion в соответствии с макетами. [#24](https://github.com/cdek-it/vue-ui-kit/issues/24)

### Added

* [**CdekFormControl**](/story/form-cdekformcontrol--change-with-deferred-validation) добавлена возможность отключить валидацию при первом вводе через пропс deferredValidation [#80](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/80)
* [**PrimeVue**](/story/prime-установка--page) добавлены плагины для подключения PrimeVue [#112](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/112)
* **lint** в eslint включено правило на console.log [#113](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/113)
* **theme** подготовлены истории для проверки темы [#114](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/114)
* [**Иконки и типографика**](/story/prime-иконки-и-типографика--page) добавлена инструкция для подключения иконок в проекты [#115](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/115), [#122](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/122)
* **theme** стилизованы компоненты формы [#116](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/116)
* [**ToggleButton**](/story/prime-form-togglebutton--primary) стилизован компонент ToggleButton [#117](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/117)
* [**SelectButton**](/story/prime-form-selectbutton--primary) стилизован компонент SelectButton [#129](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/129)
* **theme** добавлена кнопка на переключение темной темы [#123](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/123)
* **theme** перенесены токены из макетов, добавлены истории для [**MenuBar**](/story/prime-menu-menubar--primary), [**PanelMenu**](/story/prime-menu-menubar--primary) [#127](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/127)
* [**MenuBar**](/story/prime-menu-menubar--primary) стилизован компонент MenuBar [#127](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/127), [#133](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/133)
* [**Carousel**](/story/prime-carousel--карусельс-5-ювидимымииз-8-мислайдами) стилизован компонент Carousel [#134](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/134)
* [**ProgressSpinner**](/story/prime-progressspinner--primary) стилизован компонент ProgressSpinner [#136](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/136)
* [**Tag**](/story/prime-tag--default-story) стилизован компонент Tag [#136](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/136)
* [**Chip**](/story/prime-chip--default-story) добавлен сториз для Chip [#136](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/136)
* [**Skeleton**](/story/prime-skeleton--default-story) добавлен сториз для Skeleton [#136](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/136)
* [**Divider**](/story/prime-divider--default-story) добавлен сториз для Divider [#136](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/136)
* [**Button**](/story/prime-button--icon-with-label) изменены настройки шрифта для кнопки размера `large` [#137](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/137)
* [**Accordion**](/docs/prime-accordion--аккордеонс-1-йпанелью) стилизация компонента под ДС и настройка story [#2](https://github.com/cdek-it/vue-ui-kit/issues/2)
* [**Dialog**](/docs/prime-dialog--default-story) стилизация компонента под ДС и настройка story [#5](https://github.com/cdek-it/vue-ui-kit/issues/5)
* [**Message**](/docs/prime-message--primary) стилизация компонента под ДС и настройка story [#26](https://github.com/cdek-it/vue-ui-kit/issues/26)
* [**Breadcrumb**](/docs/prime-menu-breadcrumb--primary) стилизация компонента под ДС и настройка story [#31](https://github.com/cdek-it/vue-ui-kit/issues/31)
* [**Badge**](/docs/prime-misc-badge--default-story) стилизация компонента под ДС и настройка story [#33](https://github.com/cdek-it/vue-ui-kit/issues/33)
* [**Card**](/docs/prime-panel-card--default-story) стилизация компонента под ДС и настройка story [#35](https://github.com/cdek-it/vue-ui-kit/issues/35)
* [**Tab**](/docs/prime-menu-tab--primary) стилизация компонента под ДС и настройка story [#37](https://github.com/cdek-it/vue-ui-kit/issues/37)
* [**Menu**](/docs/prime-menu-menu--primary) стилизация компонента под ДС и настройка story [#39](https://github.com/cdek-it/vue-ui-kit/issues/39)
* [**TieredMenu**](/docs/prime-menu-tieredmenu--primary) стилизация компонента под ДС и настройка story [#40](https://github.com/cdek-it/vue-ui-kit/issues/40)
* [**Avatar**](/docs/prime-misc-avatar--label) стилизация компонента под ДС и настройка story [#43](https://github.com/cdek-it/vue-ui-kit/issues/43)

### Breaking change

* **build** Смена версии node на 20, поднята версия Vue до 3.5, исправлены ошибки и ворнинги при сборке [#106](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/106)
* **CdekButton** Изменены классы темы для избегания конфликтов имен с Tailwind (.outline -> .outline-theme) [#128](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/128)

## <a name="1.1.0" />[1.1.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/1.1.0)

### Added

* [**CdekAutocomplete**](/story/ui-kit-cdekautocomplete--show-all-on-focus) добавлен пропс showAllOnFocus для отображения всех опций при фокусе  [#126](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/126)

## <a name="1.0.0" />[1.0.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/1.0.0)
...
* [**CdekAlert**](/story/ui-kit-cdekalert--primary-content-align-top) теперь при длинном заголовке иконка не сжимается [#99](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/99)
* [**CdekTextarea**](/story/ui-kit-cdektextarea--auto-resize-initial-value) теперь CdekTextarea c resize="auto" расчитывает высоту с изначальным modelValue [#104](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/104)
* [**CdekTextarea**](/story/ui-kit-cdektextarea--auto-resize-change-value) теперь CdekTextarea c resize="auto" расчитывает высоту при изменении modelValue мимо события input [#104](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/104)
...
* [**CdekAlert**](/story/ui-kit-cdekalert--primary-content-align-top) добавлена возможность изменить положение контента в заголовке [#99](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/99)
* [**CdekInput**](/story/ui-kit-cdekinput-basic--show-error-if-exists) добавлен параметр `showErrorIfExists` [#103](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/103)
* [**CdekSelect**](/story/ui-kit-cdekselect--show-error-if-exists) добавлен параметр `showErrorIfExists` [#103](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/103)
* [**CdekTextarea**](/story/ui-kit-cdektextarea--show-error-if-exists) добавлен параметр `showErrorIfExists` [#103](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/issues/103)
...
## <a name="0.5.0" />[0.5.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.5.0)
...
## <a name="0.4.1" />[0.4.1](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.4.1)

### Fixed

* **CdekInput** не добавлялся класс `.cdek-input` на корневой элемент

## <a name="0.4.0" />[0.4.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.4.0)
...
## <a name="0.3.0" />[0.3.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.3.0)
...
## <a name="0.2.0" />[0.2.0](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.2.0)
...
## <a name="0.1.0-rc-010923" />[0.1.0-rc-010923](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.1.0-rc-010923)
...
## <a name="0.1.0-rc-270723" />[0.1.0-rc-270723](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.1.0-rc-270723)
...
## <a name="0.0.1" />[0.0.1](https://gitlab.cdek.ru/FrontDev/cdek-vue-ui-kit/-/releases/0.0.1)
